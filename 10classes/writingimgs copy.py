...
path = "/Users/kc/Desktop/acad/1q4/cs615/project/img_align_celeba/"
d = 1
...
for i in tqdm(range(len(images))):
    ...
    resized = cv2.resize(img, (89,109), interpolation = cv2.INTER_AREA)
    filename = path + 'resized/' +  f'{d:06d}.jpg'
